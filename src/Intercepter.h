...
/*
  ...
  Instead of using the interpreter ,
  we want to intercept the system 
  call binaries! No need for module!

*/

#include "config.h"

#ifndef LLI_INTERCEPTER_H
#define LLI_INTERCEPTER_H
...
// Intercepter - This class represents the entirety of the interpreter.
//
class Intercepter : public ExecutionEngine, public InstVisitor<Intercepter> {
public:
...
public:
  explicit Intercepter(std::unique_ptr<Module> M, ModuleInfo &&MI,
